generatePatients = function () {
  ...
  //   };
  //   mapFields(newTreatment, currentDocument, [
  //     ["sample_label", "Sample_ID"],
  ...
  //     // need more?
  //   ]);
  //   if (newTreatment['reason_for_stop']
  //       && currentDocument['Reason_for_Stopping_Treatment_Details']) {
  //     newTreatment['reason_for_stop'] += currentDocument['Reason_for_Stopping_Treatment_Details'];
  //   }
  //
  ...
  //     drugNames = currentDocument['Drug_Name'].split(";");
  //     for (var i = 0; i < drugNames.length; i++) {
  //       drugNames[i] = drugNames[i].trim();
  //     }
  //     newTreatment['drug_names'] = drugNames;
